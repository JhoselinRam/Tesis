# 1 "/home/adrian/Documents/Tesis/Sensores/dac_calibration/dac_calibration.ino"
/*
...
# 12 "/home/adrian/Documents/Tesis/Sensores/dac_calibration/dac_calibration.ino" 2
# 13 "/home/adrian/Documents/Tesis/Sensores/dac_calibration/dac_calibration.ino" 2
...
//----------------------------------//
//--------- OUTPUT VOLTAGE ---------//
float output_voltage[11 /*Do NOT change*/] = {
  0.13, // code 100
  0.60, // code 490
  1.08, // code 880
  1.56, // code 1270
...
//----------------------------------//
//---------- SETUP FUNCTON ---------//
uint16_t codes_used[11 /*Do NOT change*/];
...
void setup(){
  ...
  for(uint8_t i=0; i<11 /*Do NOT change*/; i++){
  ...
  max_code = (m*codes_used[11 /*Do NOT change*/-1]+b)*4095/5;

  //Test the calibration
  calibrated_code = map(code, min_code, max_code, 100, 4000);
  dacWrite(calibrated_code, 0x61);
...
void getLinearRegression(float buffer[3]){
  ...
  m = (11 /*Do NOT change*/*sum_xy - sum_x*sum_y) / (11 /*Do NOT change*/*sum_x2 - pow(sum_x, 2));
  b = (sum_y - m*sum_x)/11 /*Do NOT change*/;

  //Computes the correlation value
  avg = sum_y/11 /*Do NOT change*/;
